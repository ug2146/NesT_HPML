"""ResNet-34 model for analog baseline"""
import torch
...
def resnet34(preset=None):
    ...
    l4 = nn.Sequential(nn.AdaptiveAvgPool2d((1, 1)), nn.Flatten(), nn.Linear(channel[2], 10))

    model = nn.Sequential(l0, l1, l2, l3, l4)
    rpu_config = get_rpuconfig(preset)
